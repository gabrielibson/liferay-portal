...
import com.liferay.dynamic.data.mapping.uad.test.DDMFormInstanceUADTestUtil;
...
public class DDMFormInstanceUADAnonymizerTest 
	...
	@Override
	protected DDMFormInstance addBaseModel(long userId, boolean deleteAfterTestRun) throws Exception {
		DDMFormInstance ddmFormInstance =
				DDMFormInstanceUADTestUtil.addDDMFormInstance(
					_ddmFormInstanceLocalService, userId, _group);
